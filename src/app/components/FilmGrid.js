...
export default function FilmGrid({
  ...
  const loadMore = (target) => {
    ...
    fetch(tmdb_base + `/discover/movie?include_adult=false&include_video=false&language=en-US&page=${target}&region=GB&sort_by=popularity.desc&with_release_type=2%7C3&with_genres=${id}`, fetch_options)
